...
const categories = ["Todos", "Concreto", "Perfuração", "Estrutura", "Acabamento"];

const allProducts = [
  { id: 1, name: "Betoneira 400L", category: "Concreto", badge: "Popular", price: "R$ 80/dia", rating: "4.9", image: "/placeholder-cat1.jpg" },
  { id: 2, name: "Martelete Perfurador", category: "Perfuração", badge: "Novo", price: "R$ 60/dia", rating: "4.8", image: "/placeholder-cat2.jpg" },
  { id: 3, name: "Painel Metálico (Forma)", category: "Estrutura", badge: "", price: "R$ 45/dia", rating: "4.7", image: "/placeholder-cat3.jpg" },
  { id: 4, name: "Andaime Tubular", category: "Estrutura", badge: "Popular", price: "R$ 35/dia", rating: "4.9", image: "/placeholder-cat4.jpg" },
  { id: 5, name: "Compactador de Solo", category: "Acabamento", badge: "", price: "R$ 90/dia", rating: "4.8", image: "/placeholder-cat5.jpg" },
  { id: 6, name: "Esmerilhadeira Angular", category: "Acabamento", badge: "Novo", price: "R$ 40/dia", rating: "4.6", image: "/placeholder-cat6.jpg" },
];
